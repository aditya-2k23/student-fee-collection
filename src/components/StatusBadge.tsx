...
export function StatusBadge({ status, statusColor }: StatusBadgeProps) {
  ...
  if (statusColor === "red" || statusColor === "rose") {
    ...
    return (
      <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-sm font-mono text-[11px] font-bold uppercase tracking-wider border-2 border-red-600/80 dark:border-red-500/80 bg-red-50 dark:bg-red-950/40 text-red-700 dark:text-red-400 shadow-2xs">
  ...
  if (statusColor === "amber") {
    // Partial Payment Due
    return (
      <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-sm font-mono text-[11px] font-bold uppercase tracking-wider border border-amber-600/70 dark:border-amber-500/70 bg-amber-50 dark:bg-amber-950/40 text-amber-800 dark:text-amber-300">
  ...
  if (statusColor === "sky" || statusColor === "violet") {
    ...
    return (
      <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-sm text-xs font-semibold border border-blue-600/40 dark:border-blue-500/40 bg-blue-50 dark:bg-blue-950/40 text-blue-800 dark:text-blue-300">
        {status}
      </span>
    );
  }
