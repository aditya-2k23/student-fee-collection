...
const COLOR_CLASSES: Record<string, { bg: string; text: string; ring: string }> = {
  ...
  amber:   { bg: 'bg-amber-500/15',  text: 'text-amber-400',  ring: 'ring-amber-500/25' },
  emerald: { bg: 'bg-emerald-500/15',text: 'text-emerald-400',ring: 'ring-emerald-500/25' },
  sky:     { bg: 'bg-sky-500/15',    text: 'text-sky-400',    ring: 'ring-sky-500/25' },
  rose:    { bg: 'bg-rose-500/15',   text: 'text-rose-400',   ring: 'ring-rose-500/25' },
  violet:  { bg: 'bg-violet-500/15', text: 'text-violet-400', ring: 'ring-violet-500/25' },
  slate:   { bg: 'bg-slate-500/15',  text: 'text-slate-400',  ring: 'ring-slate-500/25' },
};
